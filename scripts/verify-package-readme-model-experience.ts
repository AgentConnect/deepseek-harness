...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-awiki': { kind: 'none', reason: 'Browser-side AWiki registration and messaging UI; model-facing operations belong to dsh-awiki tools.' },
  ...
  'packages/bundle/awiki-web': { kind: 'indirect', reason: 'The bundle is a static patch carrier; dsh-awiki owns the model-facing tools and results it inserts.' },
