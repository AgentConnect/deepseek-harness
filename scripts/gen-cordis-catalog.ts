...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AwikiAttachment: 'awiki.md',
  AwikiClientFactory: 'awiki.md',
  AwikiConversation: 'awiki.md',
  AwikiDownloadAttachmentRequest: 'awiki.md',
  AwikiDownloadedAttachment: 'awiki.md',
  AwikiHistoryRequest: 'awiki.md',
  AwikiIdentity: 'awiki.md',
  AwikiMessage: 'awiki.md',
  AwikiPage: 'awiki.md',
  AwikiPageRequest: 'awiki.md',
  AwikiRegistrationOtpRequest: 'awiki.md',
  AwikiRegistrationOtpResult: 'awiki.md',
  AwikiRegistrationRequest: 'awiki.md',
  AwikiResult: 'awiki.md',
  AwikiRuntimeConfig: 'awiki.md',
  AwikiSendAttachmentRequest: 'awiki.md',
  AwikiSendTextRequest: 'awiki.md',
