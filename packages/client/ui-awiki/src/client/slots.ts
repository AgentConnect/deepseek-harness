...
export interface AwikiInjected {
  ...
  /** Load browser-safe policy, identity, and the first conversation page. */
  open: () => Promise<AwikiActionResult>
  /** Stop polling and invalidate work associated with the closed drawer. */
  close: () => void
  /**
...
/** Full four-share props of the `shell.overlay` contribution. */
