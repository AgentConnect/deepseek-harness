/** AWiki browser plugin: one `shell.overlay` entry backed by Host Remote. */

import type { ClientContext } from '@deepseek-ai/dsh-client-runtime/client'
import awikiRemote from '@deepseek-ai/dsh-awiki/remote'
...
/**
 * Mount the optional AWiki Remote and register the frame-wide trigger and drawer.
