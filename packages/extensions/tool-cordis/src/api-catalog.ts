    ...
    methods: [
      {
        ...
        description: 'Register the deployment\'s sole client factory. The caller must return the resulting disposer from its own `ctx.effect`; disposal clears the slot before awaiting the client\'s quiescence and is idempotent.',
        parameters: [{ name: 'factory', description: 'synchronous factory for one owned high-level client.' }],
      ...
      },
      {
        ...
        description: 'Read settings needed by the browser presentation.',
        parameters: [],
      ...
      },
      {
        ...
        description: 'Read the deployment\'s identity status.',
        parameters: [],
      ...
      },
      {
        ...
        description: 'Send one Legacy registration verification code.',
        parameters: [{ name: 'request', description: 'Handle and phone used for the registration challenge.' }],
      ...
      },
      {
        ...
        description: 'Register and persist the deployment\'s only AWiki identity.',
        parameters: [{ name: 'request', description: 'Handle, phone, and verification code for registration.' }],
      ...
      },
      {
        ...
        description: 'List direct and existing group conversations.',
        parameters: [{ name: 'request', description: 'Optional opaque cursor and page limit.' }],
      ...
      },
      {
        ...
        description: 'Read one direct or group conversation history page.',
        parameters: [{ name: 'request', description: 'Conversation id, optional cursor, and page limit.' }],
      ...
      },
      {
        ...
        description: 'Send one text message through the deployment identity.',
        parameters: [{ name: 'request', description: 'Target, text, and idempotency key.' }],
      ...
      },
      {
        ...
        description: 'Upload and send one attachment after Host validation.',
        parameters: [{ name: 'request', description: 'Target, attachment metadata and Base64 bytes, caption, and idempotency key.' }],
      ...
      },
      {
        ...
        description: 'Download and encode one provider-verified attachment.',
        parameters: [{ name: 'request', description: 'Containing message id and attachment id.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  },
  {
    ...
    declaration: 'export type AwikiFailureCode = \'not-registered\' | \'already-registered\' | \'invalid-request\' | \'invalid-otp\' | \'challenge-expired\' | \'handle-unavailable\' | \'not-found\' | \'forbidden\' | \'conflict\' | \'rate-limited\' | \'attachment-too-large\' | \'network\' | \'remote\';',
  },
  {
